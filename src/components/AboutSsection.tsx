      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {[{
            icon: Target,
            title: "Our Mission",
            description: "To create powerful SaaS products that simplify complex business processes, enabling companies to focus on growth while our platforms handle the operational complexity with robust automation, intelligence, and seamless integrations.",
            ...
            icon: Eye,
            title: "Our Vision", 
            description: "To be the leading SaaS ecosystem where businesses discover, integrate, and scale with our suite of products that work seamlessly together to create unified digital experiences across departments and teams.",
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-3xl font-bold text-center mb-12 font-sans">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-xl font-bold text-white mb-3 font-sans">{value.title}</h4>
                        <p className="text-gray-300 leading-relaxed font-sans text-sm">{value.description}</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
